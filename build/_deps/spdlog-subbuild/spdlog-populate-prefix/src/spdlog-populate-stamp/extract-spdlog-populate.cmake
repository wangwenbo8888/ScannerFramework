...
#
get_filename_component(filename "E:/workfold/framework/build/_deps/spdlog-subbuild/spdlog-populate-prefix/src/v1.15.1.tar.gz" ABSOLUTE)
get_filename_component(directory "E:/workfold/framework/build/_deps/spdlog-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-spdlog-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-spdlog-populate${i}")
